...
const CalculatorButton: React.FC<CalculatorButtonProps> = ({
    ...
    return (
        <motion.button
            ...
            onClick={onClick}
            className={cn(
                'relative overflow-hidden rounded-2xl text-xl font-medium transition-colors duration-200 flex items-center justify-center select-none outline-none focus:ring-2 focus:ring-[#00f5ff]/50 focus:ring-offset-2 focus:ring-offset-transparent',
